...
_PORTUGUESE_TO_ENGLISH: Dict[str, str] = {
    ...
    'linhas deletadas': 'lines_deleted',
    'pts commits': 'pts_commits',
    'pts imagens': 'pts_images',
    'pts linhas': 'pts_lines',
    'pts issues criadas': 'pts_issues_created',
    'pts issues resolvidas': 'pts_issues_resolved',
    'pts prs abertos': 'pts_prs_opened',
    'pts prs aprovados': 'pts_prs_approved',
    'pts comentários': 'pts_comments',
    'pts comentarios': 'pts_comments',
